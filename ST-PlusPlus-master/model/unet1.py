...
class UNet_UMMC(nn.Module):
    def __init__(self, in_chns, class_num):
        super(UNet_UMMC, self).__init__()
        ...
        self.main_decoder = Decoder(params1)
        self.aux_decoder1 = Decoder(params2)
...
class UNet_UMMC_v2(nn.Module):
    def __init__(self, in_chns, class_num):
        super(UNet_UMMC_v2, self).__init__()
        ...
        self.main_decoder = Decoder(params1)
        self.aux_decoder1 = Decoder(params2)
        self.aux_decoder2 = Decoder(params3)

    def forward(self, x):
        feature = self.encoder(x)
        main_seg = self.main_decoder(feature)
        aux_seg1 = self.aux_decoder1(feature)
        aux_seg2 = self.aux_decoder1(feature)
