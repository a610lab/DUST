...
parser.add_argument('--root_path', type=str,
                    default='/home/a610/Project/Qzh/Prostate1/Prostate', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Prostate/Fully_Supervised', help='experiment_name')
