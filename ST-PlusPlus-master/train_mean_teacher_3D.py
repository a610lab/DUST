...
import ramps
from data.brats2019 import (BraTS2019, TwoStreamBatchSampler, BaseSTDataSets, RandomCrop,
                                   RandomRotFlip, ToTensor)
from loss import DiceLoss
from model.VNet import VNet
from val_3d import var_all_case

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='/home/a610/Project/Qzh/BraTS2019', help='Name of Experiment')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                logging.info(
                    'iteration %d : dice_score : %f' % (iter_num, dice_sample))
                model.train()
