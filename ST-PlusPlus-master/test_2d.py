...
from model.unet1 import UNet, UNet_UMMC, UNet_UMMC_v2
from model.unet import UNet_URPC

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default=r'/home/a610/Project/Qzh/ACDC', help='Name of Experiment')
...
def Inference(FLAGS):
    ...
    snapshot_path = r'/home/a610/Project/Qzh/result'
    test_save_path = "./predictions"
    if os.path.exists(test_save_path):
        shutil.rmtree(test_save_path)
    os.makedirs(test_save_path)
    # model = UNet_UMMC(in_chns=1, class_num=FLAGS.num_classes).cuda()
    model = UNet(in_chns=1, class_num=FLAGS.num_classes).cuda()
    # model = UNet_URPC(in_chns=1, class_num=FLAGS.num_classes).cuda()
    ...
    for case in tqdm(image_list):
        first_metric, second_metric, third_metric = test_single_volume(case, model, test_save_path, FLAGS)
